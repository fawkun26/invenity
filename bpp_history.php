...
<body>
  <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
    ...
    ?>
      ...
      <div class='alert alert-primary alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button><?= $_SESSION['save_status'] ?></div>
      ...
      <div class="panel-body">
        ...
        <ul class="nav nav-tabs d-flex mb-5" role="tablist">
          <li role="presentation" class="active">
            <a href="#bpp_list" id="bpp_list_tab" role="tab" data-toggle="tab" aria-controls="bpp_list" aria-expanded="true"><i class="glyphicon glyphicon-hdd"> </i> BPP History</a>

          </li>

          <a href='bpp.php' class='btn btn-primary btn-sm ml-auto d-flex items-center'>BPP</a>
          <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal_tambah_history"><i class="glyphicon glyphicon-plus"></i> Tambah History</button>
        </ul>
            ...
            foreach ($histories as $key => $history) { ?>
              <tr>
                ...
                <td style="text-align: center;">
                  <button class="btn btn-sm btn-primary btn-detail" data-target="#modal_detail" data-toggle="modal" data-bpp-history-nomor="<?= $history['nomor'] ?>" data-tanggal="<?= $history['tanggal'] ?>">Detail</button>
                  ...
                  <?php } ?>
                  <a class="btn btn-sm btn-info" href="reports/bpp_history.php?jenis=bpp_history&history=<?= $history['nomor'] ?>" target="_blank"><span class="glyphicon glyphicon-print"></span> Print</a>
                </td>
              </tr>
            <?php } ?>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">Setting nama-nama pejabat untuk report BPP History</div>
      <div class="panel-body">
        <form action="process/bpp_history.php" method="post">
          <input type="hidden" name="action" value="setting_report_bpp_history">
          <div class="row">
          <?php 
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="modal_tambah_history">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Tambah BPP History</h4>
        </div>
        <form action="process/bpp_history.php" method="post">
            <input type="hidden" name="action" value="create_bpp_history">
            <input type="hidden" name="redirect" value="bpp_history">
          <div class="modal-body">
            <p class="mb-2">Apakah anda ingin menambahkan BPP history?</p>
          </div>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="modal_detail">
    <div hidden id="is_editable_bpp_history" data-is-editable="true"></div>
    <div hidden id="is_admin_bpp_history" data-is-admin="<?php echo $_SESSION['level'] == 'admin' ? 'true' : 'false' ?>"></div>
