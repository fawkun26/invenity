...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(40, 10, "lpb_quantity", 1, 0);
        $this->Cell(25, 10, "lpb_unit", 1, 0);
        $this->Cell(30, 10, "lpb_code", 1, 0);
        $this->Cell(40, 10, "lpb_description", 1, 0);
        $this->Cell(40, 10, "lpn_condition", 1, 0);
...
$no = 0;
$datas = $lpbClass->show_lpb_report($by, $criteria);
...
foreach ($datas as $data) {
    ...
    $pdf->Cell(40, 10, $data['lpb_quantity'], 1, 0);
    $pdf->Cell(25, 10, $data['lpb_unit'], 1, 0);
    $pdf->Cell(30, 10, $data['lpb_code'], 1, 0);
    $pdf->Cell(40, 10, $data['lpb_description'], 1, 0);
    $pdf->Cell(40, 10, $data['lpb_condition'], 1, 0);
