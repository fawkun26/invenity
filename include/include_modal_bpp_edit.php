...
?>
<div class="modal fade" tabindex="-1" role="dialog" id="modal_bpp_edit">
  <div class="modal-dialog modal-lg">
    <form class="form-horizontal" name="form_bpp" id="form_bpp_edit" method="post" action="process/bpp.php">
      <input type="hidden" name="action" value="edit_bpp">
      <div class="modal-content">
        ...
        <div class="modal-body" id="modal_content_bpp">
          ...
          <input type="hidden" id="input_old_out_quantity_edit" name="old_out_quantity">
          <input type="hidden" id="input_old_device_id_edit" name="old_device_id">
          <div class="form-group">
