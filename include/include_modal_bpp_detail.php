  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Detail BPP</h4>
      </div>
      <div class="modal-body">
      <ul class="list-group">
        <li class="list-group-item">No: <span data-holder="span-no"></span></li>
        <li class="list-group-item">No History: <span data-holder="span-no-history"></span></li>
        <li class="list-group-item">Diminta: <span data-holder="span-request-quantity"></span></li>
        <li class="list-group-item">Satuan: <span data-holder="span-request-unit"></span></li>
        ...
        <li class="list-group-item">Dikeluarkan: <span data-holder="span-out-quantity"></span></li>
