  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modal_title_lpb">Add Lpb</h5>
                  ...
                  <div class="box-header with-border"><!-- /.box-header -->
                   ...
                   <font class="control-font col-sm-9" size="2" color="red">*Device Code and Confirmation Device Code Must Be Same</font>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input required type="text" class="form-control" placeholder="Condition" name="lp_condition" id="lp_condition" <?php if (isset($_SESSION["new_lp_condition"])) { echo " value='".$_SESSION["new_lp_conditon"]."'"; unset($_SESSION['new_lp_condition']); } ?>><br>
                      </div>
                    </div>
                        <!-- <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <input type="hidden" name="action" id="action" value="add_lpb">
