            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="modal_content_device">
                    <!-- <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" name="dev_code" id="dev_code" <?php if (isset($_SESSION["new_dev_code"])) { echo " value='".$_SESSION["new_dev_code"]."'"; unset($_SESSION['new_dev_code']); } ?>>
                        </div>
                    </div> -->
                    <div id="only_edit">
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" name="dev_quantity" id="dev_quantity" <?php if (isset($_SESSION["new_dev_quantity"])) { echo " value='".$_SESSION["new_dev_quantity"]."'"; unset($_SESSION['new_dev_quantity']); } ?>>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3">Minimum Quantity</label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control" name="minimum_quantity" id="minimum_quantity" <?php if (isset($_SESSION["new_minimum_quantity"])) { echo " value='".$_SESSION["new_minimum_quantity"]."'"; unset($_SESSION['new_minimum_quantity']); } ?> min="0">
                        </div>
                    </div>
                    <!-- baru // -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control tinymce" name="dev_description" id="dev_description"> <?php if (isset($_SESSION["new_dev_description"])) { echo $_SESSION["new_dev_description"]; unset($_SESSION['new_dev_description']); } ?></textarea>
                        </div>
                    </div>
