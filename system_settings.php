...
if (!isset($_SESSION['username']) && !isset($_SESSION['level'])) {
	...
	if (isset($_POST['action']) && $_POST['action']=="sign_out") {
    	...
    	<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
    		<?php
    			if ($save_status!="") {
    				echo "<div class='alert alert-success'>$save_status</div>";
    			}
    		?>
    		<div class="panel panel-primary">
    			...
    			<div class="panel-body">
    				<form name="form_settings" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		    			...
		    			<div class="form-group">
		    				<label for="inventory_user" class="control-label col-sm-3">User</label>
		    				<div class="col-sm-9">
			    				<input type="text" name="inventory_users" id="inventory_users" class="form-control" value="<?php echo $invClass->setting_data("inventory_users"); ?>">
		    				</div>
		    			</div>
